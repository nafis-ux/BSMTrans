  ...
  try {
    ...
    const mobil = await prisma.mobil.update({
      ...
      data: {
        ...
        ...(tipe !== undefined && { tipe }),
        ...(hargaPerHari !== undefined && { hargaPerHari: parseInt(hargaPerHari) }),
        ...(biayaDriver !== undefined && { biayaDriver: parseInt(biayaDriver) }),
        ...(statusTersedia !== undefined && { statusTersedia }),
        ...(kursi !== undefined && { kursi: parseInt(kursi) }),
        ...(bagasi !== undefined && { bagasi: parseInt(bagasi) }),
  ...
  try {
    ...
    const newMobil = await prisma.mobil.create({
      data: {
        ...
        namaMobil,
        tipe: tipe || "Standar",
        hargaPerHari: parseInt(hargaPerHari),
  ...
  try {
    ...
    const updatedTravel = await prisma.ruteTravel.update({
      ...
      data: {
        ...
        ...(hargaTiket !== undefined && { hargaTiket: parseInt(hargaTiket) }),
        ...(jadwal !== undefined && { jadwal }),
        ...(armada !== undefined && { armada }),
        ...(totalKursi !== undefined && { totalKursi: parseInt(totalKursi) }),
        ...(sisaKursi !== undefined && { sisaKursi: parseInt(sisaKursi) }),
